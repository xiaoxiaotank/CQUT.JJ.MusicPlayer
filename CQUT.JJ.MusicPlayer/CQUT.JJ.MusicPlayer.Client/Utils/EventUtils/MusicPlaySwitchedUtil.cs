...
namespace CQUT.JJ.MusicPlayer.Client.Utils.EventUtils
{
    public class MusicPlaySwitchedUtil
    {
        ...
        /// <param name="isDescending">true 降序 null 重复 false 升序</param>
        public static void InvokeFromQM(MusicPlayMode musicPlayMode, bool? isDescending = null)
        {
    ...
    public class MusicPlaySwitchedEventArgs : EventArgs
    {
        ...
        public MusicPlaySwitchedEventArgs(MusicPlayMode musicPlayMode,bool? isDescending = null)
        {
